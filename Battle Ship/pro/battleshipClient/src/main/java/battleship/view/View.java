...
public class View {
	...
	public int startGameMenu(String login, int rating, int ID) {
		Scanner scanner = new Scanner(System.in);
		System.out.println();
		...
		while (input == 0) {
			...
			System.out.println("3 - View Rating table;");
	...
	public void outputRatings(TreeMap<Integer, ArrayList<String>> ratings) {
		System.out.println();
		System.out.println("Rating table:");
		System.out.println();
		for (Map.Entry<Integer, ArrayList<String>> it : ratings.entrySet()) {
			for (String iter : it.getValue()) {
				System.out.println(iter + ":  " + it.getKey());	
			}			
		}
		System.out.println();
	}
